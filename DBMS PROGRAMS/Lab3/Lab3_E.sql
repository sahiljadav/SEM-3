...
--Branch name to ‘ANDHERI whose Account No is 110.UPDATE DEPOSIT SET ADATE = NULL, BNAME = 'ANDHERI'WHERE ACTNO = 110UPDATE FACULTY SET BRANCH = 'CSE'WHERE BRANCH = 'COMPUTER'UPDATE FACULTY SET MOBILE_NO = 9999988888WHERE PNAME = 'PROF. ANKIT PATEL'UPDATE FACULTY SET CITY = 'RAJKOT'WHERE CITY = 'HADALA'UPDATE FACULTY SET MOBILE_NO = NULLWHERE PNAME = 'PROF. BAHVIN PATEL'UPDATE FACULTY SET ID = 'CSE_TEMP_01'WHERE DELETE FROM TABLE_NAMEWHERE CONDITION DELETE FROM EMPLOYEEWHERE CITY = 'RAJKOT'DELETE FROM EMPLOYEEWHERE AGE = 30DELETE FROM EMPLOYEEWHERE CITY IN ('SURAT','VALSAD')DELETE FROM EMPLOYEEWHERE AGE IS NULL--ALTER IS USED TO ADD NEW COLUMN--ALTER IS USED TO DROP COLUMN--ALTER IS USED TO MODIFY COLUMN--SYNTAX:-ALTER TABLE TABLE_NAME
...
ALTER TABLE EMPLOYEE
ADD MOBILE_NO VARCHAR(50), ADDRESS VARCHAR(50);
